      ...
      <section className="container-card-exp">
        ...
        <div className="card-exp">
          ...
          <div className="li-wrapper-exp">
            ...
            <li>
              React.js 위에서 Modal screen 및, class state 구성을 통한 남은 시간
              기능을 구현.
            </li>
            <li>
        ...
        <div className="card-exp">
          ...
          <div className="li-wrapper-exp">
            ...
            <li>
              취미와 독학으로 시작하여 현재 주요하게 사용되는 웹개발 스택들을
              기반으로 응용 가능한 여럿프로젝트들을 구성 해 보며, 점차 자료 구조
              및 문제 해결 연습을 통한 효율적이고 보기 좋은 클린 코드구성에
              관심이 많아졌습니다. 유연함과 더불어 해당 언어 기반으로 자유롭게
              파생될 수 있
            </li>
            <li>
