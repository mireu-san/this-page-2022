        ...
        <section className="container-card-exp">
          ...
          <div className="card-exp-2">
            ...
            <div className="li-wrapper-exp">
              ...
              <li>
                React.js 에서 TypeScript 로의 변환 작업에 기여. Typescript 내
                코드 구성의 전개 방식에 대한 이해도 증진.
              </li>
              <li>
                React 에서 Modal screen 및, 상태 관리를 접목한 남은 시간 기능을
                구성.
              </li>
              <li>
                PM 및 디자이너 측과 소통을 통한 프로젝트 이해도 점검 및, 해당
                조직 내 지식DB 동기화 및 CI/CD 구성 계획에 기여. 컴포넌트 구성
                기여 및 업데이트 내역에 대한 문서화 경험.
              </li>
            </div>
          </div>
          {/* 독학 */}
